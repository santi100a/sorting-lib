...
module.exports = function heapSort(arr, opts) {
    if (opts === void 0) { opts = { comparator: core_1.__defAscending, order: 'ascending' }; }
    assertInstanceOf(arr, Array, 'arr');
    assertDefined(opts, 'opts');
    assertTypeOf(opts, 'object');
    var _a = opts.comparator, comparator = _a === void 0 ? core_1.__defAscending : _a, _b = opts.order, order = _b === void 0 ? 'ascending' : _b;
    var n = arr.length;
